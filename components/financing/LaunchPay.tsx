...
import { Rocket, ChevronRight, CheckCircle, Zap, Shield, X } from "lucide-react";
...
interface LaunchPayProps {
  ...
  showPrequal?: boolean;
  className?: string;
  context?: "customer" | "dealer" | "affiliate";
}
...
const DISCLOSURE =
  "LaunchPay is a financing service powered by Affirm, Inc. All loans are issued by Affirm\u2019s lending partners. Subject to credit approval. Rates vary by creditworthiness. See affirm.com/licenses for details.";

const DISCLOSURE_SHORT =
  "Powered by Affirm, Inc. \u00B7 Subject to credit approval \u00B7 Rates vary by creditworthiness";
      ...
      <>
        ...
        >
          ...
          <div className="relative p-6 space-y-5">
            ...
            <p className="text-zinc-600 text-[11px] text-center">{DISCLOSURE_SHORT}</p>
          </div>
        </div>
        {modalOpen && <PrequalModal amount={amount} m3={m3} m12={m12} m24={m24} onClose={() => setModalOpen(false)} context={context} />}
      </>
      ...
      <div className="relative w-full max-w-sm rounded-3xl overflow-hidden"
        ...
        <div className="p-5 space-y-4">
          ...
          <p className="text-zinc-500 text-xs text-center">
            Select Affirm at checkout to apply — instant decision, no impact to your credit score.
          </p>
