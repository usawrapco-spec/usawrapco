...
import AccessManagerClient from '@/components/admin/AccessManagerClient'
        ...
        <main style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div style={{ textAlign: 'center' }}>
            ...
            <div style={{ fontSize: 13, color: 'var(--text3)' }}>
              Only admins and owners can manage team access.
            </div>
          </div>
        </main>
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', background: 'var(--bg)', overflow: 'hidden' }}>
      ...
      <main style={{ flex: 1, overflowY: 'auto', padding: '20px 24px', paddingBottom: 80 }}>
        <AccessManagerClient currentProfile={profile as Profile} />
      </main>
      <div className="md:hidden"><MobileNav /></div>
    </div>
  )
