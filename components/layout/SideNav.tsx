...
import {
  ...
  Bell, Eye, FileImage, Mail, Calculator, Cog,
} from 'lucide-react'
...
const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/wrapup',                     label: 'Wrap-Up',           icon: CheckSquare },
      { href: '/install',                    label: 'Install Hub',       icon: Hammer,        roles: ['owner', 'admin', 'installer'] },
      { href: '/install/schedule',           label: 'Install Schedule',  icon: CalendarDays,  roles: ['owner', 'admin', 'installer'] },
      { href: '/install/bids',               label: 'Install Bids',      icon: ShoppingBag,   roles: ['owner', 'admin', 'installer'] },
      { href: '/install/reports',            label: 'Install Reports',   icon: BarChart3,     roles: ['owner', 'admin'] },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/design/manage',    label: 'Manage Designs', icon: Layers },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/roi/dashboard',  label: 'ROI Dashboard',  icon: TrendingUp },
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/fleet-map', label: 'Live Map',       icon: Map },
      { href: '/mileage',   label: 'Mileage',        icon: Gauge },
      { href: '/maintenance', label: 'Maintenance',  icon: Wrench, roles: ['owner', 'admin', 'production'] },
    ],
  },
  {
    id: 'sourcing',
