...
import type { Profile, Project, DesignProject } from '@/types'
...
export default async function DesignPage() {
  ...
  const [{ data: projects }, { data: designProjects }] = await Promise.all([
    supabase
      .from('projects')
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6">
          <DesignClient
            ...
            initialDesignProjects={(designProjects as DesignProject[]) || []}
          />
        </main>
      </div>
    </div>
