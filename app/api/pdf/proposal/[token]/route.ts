...
const s = StyleSheet.create({
  ...
  bodyWide: { padding: '16px 36px 64px 36px' },
  ...
  // Billing
  billingRow: { flexDirection: 'row', marginBottom: 14 },
  billingCol: { flex: 1 },
  billName: { fontSize: 15, fontWeight: 700, marginBottom: 2 },
  billSub: { fontSize: 12, fontWeight: 600, marginBottom: 2 },
  ...
  // Vehicle card
  vehicleCard: { backgroundColor: PDF_COLORS.lightGray, borderRadius: 6, padding: 12, marginBottom: 14, borderLeftWidth: 4, borderLeftColor: PDF_COLORS.accent },
  vehicleMain: { fontSize: 16, fontWeight: 700, marginTop: 2, marginBottom: 4 },
  vehicleRow: { flexDirection: 'row', flexWrap: 'wrap' },
  vehicleMeta: { fontSize: 10, color: PDF_COLORS.textSecondary, marginRight: 16, marginTop: 1 },
  // Table
  tableHeader: { flexDirection: 'row', backgroundColor: PDF_COLORS.darkAlt, paddingHorizontal: 10, paddingVertical: 6 },
  ...
  // Totals
  totalsBlock: { alignItems: 'flex-end', marginTop: 8, marginBottom: 14 },
  ...
  totalsLine: { borderBottomWidth: 1, borderBottomColor: PDF_COLORS.border, width: 260, marginVertical: 5 },
  ...
  totalsDepositRow: { flexDirection: 'row', width: 260, justifyContent: 'space-between', marginTop: 5 },
      ...
      React.createElement(View, null,
        ...
        React.createElement(View, { style: s.nextStepsRow },
          React.createElement(View, { style: [s.card, s.cardGreen] as any },
            ...
            React.createElement(Text, { style: { ...s.cardText, marginBottom: 6 } }, '50% deposit to secure your install slot:'),
            React.createElement(Text, { style: s.cardPrice }, formatCurrency(deposit)),
            React.createElement(View, { style: { marginTop: 8, borderTopWidth: 1, borderTopColor: PDF_COLORS.border, paddingTop: 8 } },
              React.createElement(Text, { style: s.cardText }, '✓ Production in as little as 5 business days'),
              React.createElement(Text, { style: s.cardText }, '✓ 3-year full installation warranty'),
              React.createElement(Text, { style: s.cardText }, '✓ Balance due on delivery: ' + formatCurrency(balance)),
            ),
            React.createElement(Text, { style: { ...s.cardLink, marginTop: 8 } }, BRAND.phone),
          ),
          React.createElement(View, { style: [s.card, s.cardPurple] as any },
            React.createElement(Text, { style: s.cardTitle }, 'Add Custom Design'),
            React.createElement(Text, { style: s.cardText }, 'Work 1-on-1 with our in-house designer to create a wrap that turns heads.'),
            React.createElement(View, { style: { marginTop: 8, borderTopWidth: 1, borderTopColor: PDF_COLORS.border, paddingTop: 8 } },
              React.createElement(Text, { style: s.cardText }, '✓ AI mockup — see it before we print'),
              React.createElement(Text, { style: s.cardText }, '✓ 3 unique concepts included'),
              React.createElement(Text, { style: s.cardText }, '✓ Applied toward your total'),
            ),
            React.createElement(Text, { style: { ...s.cardPrice, fontSize: 16 } }, '$1,000'),
            React.createElement(Text, { style: { ...s.cardLink, marginTop: 4 } }, BRAND.email),
          ),
        ),
      ),
    ),
