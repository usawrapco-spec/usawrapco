...
export default async function SalesOrderDocPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100vh', background: 'var(--bg)', overflow: 'hidden' }}>
      ...
      <main style={{ flex: 1, overflowY: 'auto' }}>
        <ProjectDocView project={project} lineItems={lineItems || []} type="salesorder" profile={profile as Profile} />
      </main>
